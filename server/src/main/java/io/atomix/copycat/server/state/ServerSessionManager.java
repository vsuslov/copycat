...
class ServerSessionManager {
   ...
   */
  ServerSessionManager registerConnection(long sessionId, long connectionId, Connection connection) {
   ...
   * Registers a connection.
   */
  ServerSessionManager registerConnection(long sessionId, long connectionId) {
